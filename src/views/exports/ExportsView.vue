              ...
              <v-card :elevation="4" height="100%" class="d-flex flex-column">
                ...
                <v-card-subtitle class="pt-0 text-caption">
                  ...
                  <v-card-text class="flex-grow-1">
                    ...
                    <v-chip :color="getStatusColor(exportJob.status)" small label text-color="white"
                  ...
                  <v-divider/>
                  <v-card-actions>
                    <v-btn icon small @click="refreshSingleExportStatus(exportJob)"
                           :loading="isRefreshing[exportJob.id]">
                    ...
                    <v-spacer/>
                    <v-btn small color="red" text @click="deleteExport(exportJob.id)"
                           :disabled="true">
